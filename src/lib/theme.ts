// The colour themes and typefaces (the originals plus Hippiecore, Modern and European Art). Each person's choice is
...
export const FONTS: Record<string, { name: string; note: string; serif: string; sans: string }> = {
  ...
  groovy: { name: 'Groovy', note: 'Chunky seventies headlines over a soft, rounded body — pairs with Hippiecore', serif: "'Shrikhand',Georgia,serif", sans: "'Nunito',Helvetica,Arial,sans-serif" },
  ...
  classical: { name: 'Classical', note: 'Old-style Garamond headlines over a bookish serif body — pairs with European Art', serif: "'Cormorant Garamond',Garamond,Georgia,serif", sans: "'Lora',Georgia,serif" },
}
